...
export class Pokemon {
	...
	*/
	...
	runEffectiveness(move: ActiveMove) {
		...
		if (this.hasAbility('Tera Shell') && !this.battle.suppressingAbility(this)) {
			if (this.abilityState.resisted) return -1; // multi-hit: mantiene el “not very effective” en todos los hits
