...
export class DexSpecies {
	...
	getByID(id: ID): Species {
		...
		if (alias) {
			if (Object.prototype.hasOwnProperty.call((this.dex.data as any).FormatsData || {}, id)) {
				// special event ID
				species = new Species({
				...
				if (species.cosmeticFormes) {
					for (const forme of species.cosmeticFormes) {
						if (Object.prototype.hasOwnProperty.call((this.dex.data as any).Pokedex || {}, toID(forme))) continue;
						if (toID(forme) === id) {
							species = new Species({
								...species,
								name: forme,
		...
		if (!Object.prototype.hasOwnProperty.call((this.dex.data as any).Pokedex || {}, id)) {
			let aliasTo = '';
		...
		if (id && Object.prototype.hasOwnProperty.call((this.dex.data as any).Pokedex || {}, id)) {
	...
	getLearnsetData(id: ID): Learnset {
		...
		if (!Object.prototype.hasOwnProperty.call((this.dex.data as any).Learnsets || {}, id)) {
