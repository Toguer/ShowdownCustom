...
export class DexConditions {
	...
	getByID(id: ID): Condition {
		...
		if (id.startsWith('item:')) {
		...
		} else if (Object.prototype.hasOwnProperty.call((this.dex.data as any).Rulesets || {}, id)) {
			...
			return condition;
		} else if (Object.prototype.hasOwnProperty.call((this.dex.data as any).Conditions || {}, id)) {
			condition = new Condition({ name: id, ...this.dex.data.Conditions[id] });
		} else if (
			(Object.prototype.hasOwnProperty.call((this.dex.data as any).Moves || {}, id) && (found = (this.dex.data as any).Moves[id]).condition) ||
			(Object.prototype.hasOwnProperty.call((this.dex.data as any).Abilities || {}, id) && (found = (this.dex.data as any).Abilities[id]).condition) ||
			(Object.prototype.hasOwnProperty.call((this.dex.data as any).Items || {}, id) && (found = (this.dex.data as any).Items[id]).condition)
		  ) {
