...
export class DexTypes {
	...
	getByID(id: ID): TypeInfo {
		...
		if (typeName && Object.prototype.hasOwnProperty.call((this.dex.data as any).TypeChart || {}, id)) {
	...
	isName(name: string | null | undefined): boolean {
		...
		const typeName = id.charAt(0).toUpperCase() + id.substr(1);
		return name === typeName && Object.prototype.hasOwnProperty.call((this.dex.data as any).TypeChart || {}, id);
	}
